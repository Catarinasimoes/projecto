...
#ifndef CAPTURETHREADIR_HPP
#define CAPTURETHREADIR_HPP
...
private:
	...
	int kinect_infrared_width, kinect_infrared_height;
	//Body
...
public:
	...
	CaptureThreadIR(Buffer<cv::Mat> &buffer, Buffer<cv::Rect> &faceArea, Buffer<vector<cv::Point>> &samplingPoints, EvmSettings &settings);
